# Generated by Django 2.1.7 on 2019-05-07 02:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_order_time', models.DateTimeField(auto_now_add=True, null=True, verbose_name='报修时间')),
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user', to=settings.AUTH_USER_MODEL, verbose_name='用户')),
            ],
            options={
                'verbose_name': '工单表',
